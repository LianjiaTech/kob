...
public @Slf4j class TaskDispatcher {
    ...
    private void dispatcher0(String parentPath, String currentChild) {
        ...
        String designatedNode = context.getDesignatedNode();
        String recommendNode = context.getRecommendNode();
        String tryToExclusionNode = context.getTryToExclusionNode();
        ...
        final String taskKey = context.getTaskKey();
        ...
        clientContext.getPool().execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    log.info(ClientLogConstant.info103(context.getJobCn(), context.getTaskKey(), result.getState()));
