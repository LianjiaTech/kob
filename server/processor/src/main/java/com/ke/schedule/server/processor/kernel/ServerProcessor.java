...
import com.ke.schedule.server.core.model.oz.MasterElectorNotice;
...
//            List<String> taskPathList = curator.getChildren(ZkPathConstant.clientTaskPath(serverContext.getCluster(), projectCode));
